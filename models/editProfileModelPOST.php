...
$db->query('CALL insert_further_user_data('.$_SESSION['user_id'].', "'.$_SESSION['form_description'].'", "'.$_SESSION['form_email'].'", '.$_SESSION['form_password'].', "'.$_SESSION['link_names'].'", "'.$_SESSION['link_bodies'].'", "'.$_SESSION['form_technologies'].'")');
