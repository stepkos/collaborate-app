...
SELECT offert.id, CONCAT(users.name," ",users.surname) as "owner", offert.owner_id, offert.name, project_category.name as "project category", offert.description from offert
